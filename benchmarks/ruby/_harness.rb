...
# Capture the real monotonic clock as a bound method so the timing loop is immune
# to any later monkey-patching of Process.clock_gettime.
...
def bench(label, inner)
  ...
  OUTER.times do
    ...
    inner.times { yield }
    dt = CLOCK.call(Process::CLOCK_MONOTONIC) - t0
